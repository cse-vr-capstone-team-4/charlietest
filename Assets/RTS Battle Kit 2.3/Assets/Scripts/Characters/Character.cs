...
public class Character : MonoBehaviour {
	...
	public IEnumerator die(){
		...
		if(ragdoll == null){
            ...
            particles.transform.localScale = new Vector3(0.33f, 0.33f, 0.33f);

            if (GameObject.Find("Manager") != null)
				particles.transform.parent = GameObject.Find("Manager").transform;
		}
		else{
			GameObject deadBody = Instantiate(ragdoll, transform.position, transform.rotation);
            deadBody.transform.parent = GameObject.Find("GameObject3").transform;
            deadBody.transform.localScale = new Vector3(0.33f, 0.33f, 0.33f);
		}
		***/
